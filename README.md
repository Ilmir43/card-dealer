...
карты и получить результат распознавания. Также теперь можно
загрузить файл с видео, в котором приложение определит карты и
выведет их в порядке появления.
